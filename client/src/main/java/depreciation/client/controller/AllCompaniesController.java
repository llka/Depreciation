...
public class AllCompaniesController {
    ...
    private void fillTable() {
        try {
            ContextHolder.getClient().sendRequest(new CommandRequest("GET_ALL_COMPANIES"));
    ...
    public static void setFirstOpened(boolean firstOpened) {
        AllCompaniesController.firstOpened = firstOpened;
    }
    ...
    public static void setMain(Main main) {
        AllCompaniesController.main = main;
    }
}
